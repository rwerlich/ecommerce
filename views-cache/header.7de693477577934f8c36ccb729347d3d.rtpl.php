...
<html lang="pt-br">
  <head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="/ecommerce/assets/site/css/bootstrap.min.css">
    
    <!-- Font Awesome -->
    <link rel="stylesheet" href="/ecommerce/assets/site/css/font-awesome.min.css">
    
    <!-- Custom CSS -->
    <link rel="stylesheet" href="/ecommerce/assets/site/css/owl.carousel.css">
    <link rel="stylesheet" href="/ecommerce/assets/site/css/style.css">
    <link rel="stylesheet" href="/ecommerce/assets/site/css/responsive.css">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="/ecommerce/cart">Carrinho - <span class="cart-amunt">R$ <?php echo getCartVlSubTotal(); ?></span> <i class="fa fa-shopping-cart"></i> 
