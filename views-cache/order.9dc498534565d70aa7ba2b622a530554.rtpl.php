    ...
    <section class="invoice">
        ...
        <div class="row">
            ...
            <h2 class="page-header">
                <img src="/ecommerce/assets/site/img/php-min.png" alt="Logo">
        ...
        <div class="row invoice-info">
            ...
            Para
            <address>
                <strong><?php echo htmlspecialchars( $order["nome"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong><br>
                ...
                <?php if( $order["phone"] && $order["phone"]!='0' ){ ?>Telefone: <?php echo htmlspecialchars( $order["phone"], ENT_COMPAT, 'UTF-8', FALSE ); ?><br><?php } ?>
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                ...
                <button type="button" onclick="window.open('/ecommerce/boleto/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>')" class="btn btn-default pull-left" style="margin-left: 5px;">
